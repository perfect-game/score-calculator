...
describe('Traditional Score Manager', () => {
  describe('Push', () => {
    ...
    test('Frame Length', () => {
      expect(scoreManager.frames.length).toBe(10);
    });
  ...
  describe('Push and Pop', () => {
    ...
    test('Frame Length', () => {
      expect(scoreManager.frames.length).toBe(7);
    });

    test('Total Score', () => {
      expect(scoreManager.totalScore).toBe(140);
    });
    ...
    test('Score per Frames', () => {
      ...
      expect(scoreManager.frames[4].score).toBe(17);
      expect(scoreManager.frames[5].score).toBe(16);
      expect(scoreManager.frames[6].score).toBe(10);
    });
